...
def _corners_moved(wrfnc, first_ll_corner, first_ur_corner, latvar, lonvar):
    ...
    # DTD: getvar was failing here on my WRF-DART output because the latitude/
    # longitude variables are missing the leading "Time" dimension, but the
    # original code below is expecting it to be there, leading to an IndexError
    # The code now returns False if it can't find the Time dimension.
